...
export function WorkspaceForm({ onWorkspaceAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const validPriority = Object.values(PRIORITY).includes(data.priority)
      ? data.priority
      : PRIORITY.MEDIUM;
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="flex justify-center">
          <Image
            src="https://res.cloudinary.com/dwgwb5vro/image/upload/v1741447763/buku_yxhzod.png"
            width={300}
            height={200}
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-6">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <Button
              type="submit"
              className="bg-blue-700 text-white font-semibold rounded-md hover:bg-blue-400 cursor-pointer"
              disabled={isSubmitting}
            >
